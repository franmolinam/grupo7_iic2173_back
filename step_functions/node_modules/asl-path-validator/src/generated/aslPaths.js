...
function peg$parse(input, options) {
  ...
  var peg$f28 = function(func, arg1, arg2) {return {func, arg1, arg2}};
  var peg$f29 = function(func, arg1, arg2) {return {func, arg1, arg2}};
  var peg$f30 = function(func, arg1, arg2) {return {func, arg1, arg2}};
  var peg$f31 = function(func, arg1, arg2) {return {func, arg1, arg2}};
  var peg$f32 = function(func, args) {return {func, args}};
  var peg$f33 = function(func, args) {return {func, args}};
  var peg$f34 = function(func, args) {return {func, args}};
  var peg$f35 = function() {return {
   	head: null,
    tail: [] }
   };
  var peg$f36 = function(head) {return {
   	head,
    tail: [] }
   };
  var peg$f37 = function() { return []};
  var peg$f38 = function(head, tail) {return {
   	head,
    tail: tail.map((t) => t[2]) }
   };
  var peg$f39 = function(start, end) {return {start, end, slice:true}};
  var peg$f40 = function(start) {return {start:start, end:null, slice: true}};
  var peg$f41 = function(end) {return {start:null, end, slice: true}};
  var peg$f42 = function(exp) {return {exp, filter: true}};
  var peg$f43 = function(offset) {return {node:"@", offset: -offset, atmark: true}};
  var peg$f44 = function(op) {return {node: "@", atmark: true}};
  var peg$f45 = function(op) {return {node: "@", atmark: true}};
  var peg$f46 = function(exp) {return {exp}};
  var peg$f47 = function(path, op, minus, val) {return {path, op, val: minus==='-'?-val:val}};
  var peg$f48 = function(minus, nbr) { return (minus === '-' ? -1 : 1) * parseFloat(nbr)};
  var peg$f49 = function(v) {return v.join('')};
  var peg$f50 = function(v) {return v.join("")};
  var peg$f51 = function(v) {return v.join("")};
  var peg$f52 = function(c) { return c; };
                            ...
                            if (s0 === peg$FAILED) {
                              ...
                              if (s0 === peg$FAILED) {
                                ...
                                if (s1 !== peg$FAILED) {
                                  ...
                                  if (s2 !== peg$FAILED) {
                                    s3 = peg$parse_();
                                    s4 = peg$parsejsonpath_();
                                    if (s4 !== peg$FAILED) {
                                      s5 = peg$parse_();
                                      s6 = peg$parseCOMMA();
                                      if (s6 !== peg$FAILED) {
                                        s7 = peg$parse_();
                                        s8 = peg$parsejsonpath_();
                                        if (s8 !== peg$FAILED) {
                                          s9 = peg$parse_();
